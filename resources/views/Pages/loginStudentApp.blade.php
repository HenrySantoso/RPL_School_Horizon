...
<div class="login-container">
    ...
    <form action="/login" method="post">
        ...
        <div class="mb-3 position-relative">
            ...
            <input type="text" class="form-control ps-5" placeholder="Username" name="username" id="username" required>
        </div>
        <div class="mb-3 position-relative">
            ...
            <input type="password" class="form-control ps-5 pe-5" placeholder="Password" name="password" id="password" required>
            <i class="fas fa-eye position-absolute top-50 end-0 translate-middle-y me-2 toggle-password" id="togglePassword"></i>
        </div>
